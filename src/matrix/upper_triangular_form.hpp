...
template <class T>
Matrix<my::float_t> upper_triangular_form(const Matrix<T>& mat) {
  matrix_is_not_square(mat);

  const size_t number_of_rows = mat.size();
...
template <class T>
math::fmatrix_t fraction_upper_triangular_form(const Matrix<T>& mat) {
  matrix_is_not_square(mat);
...
//
// template <class T>
// math::fmatrix_t fraction_upper_triangular_form(const Matrix<T>& mat, size_t* c) {
//   matrix_is_not_square(mat);
