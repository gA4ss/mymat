...
void test_orth() {
  ...
  std::cout << "mat det = " << matrix::det<number_t>(mat1) << std::endl << std::endl;
  std::cout << "omat det = " << matrix::det<number_t>(omat1) << std::endl << std::endl;
  ...
  std::cout << (matrix::transposition<number_t>(omat2) * omat2) << std::endl << std::endl;
}
